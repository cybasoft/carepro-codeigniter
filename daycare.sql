...
INSERT INTO options (option_name, option_value, autoload) VALUES
  ('company_name', 'DaycarePRO', NULL),
  ('slogan', 'daycare management system', NULL),
  ('email', 'app@admin.com', NULL),
  ('phone', '12345677', NULL),
  ('fax', '1234566', NULL),
  ('street', '1245 State st', NULL),
  ('street2', '', NULL),
  ('city', 'New York', NULL),
  ('state', 'NY', NULL),
  ('postal_code', '12345', NULL),
  ('country', 'USA', NULL),
  ('timezone', 'America/New_york', NULL),
  ('google_analytics', '', NULL),
  ('currency_symbol', '$', NULL),
  ('currency_abbreviation', 'USD', NULL),
  ('date_format', 'm/d/Y h:i a', NULL),
  ('allow_registration', '0', NULL),
  ('allow_reset_password', '1', NULL),
  ('enable_captcha', '0', NULL),
  ('demo_mode', '0', NULL),
  ...
  ('smtp_port', '25', NULL),
  ('logo', 'logo.png', NULL),
  ('invoice_logo', 'invoice_logo.png', NULL),
  ('stripe_pk_live', '', NULL),
  ('stripe_sk_live', '', NULL),
  ('stripe_pk_test', '', NULL),
  ('stripe_sk_test', '', NULL),
  ...
  ('top_nav_link_color', '', NULL),
  ('left_sidebar_bg_color', '', NULL),
  ('left_sidebar_link_color', '', NULL),
  ('custom_css', '', NULL),
  ('lockscreen_timer', 5, NULL),
  ('daily_checkin', 1, NULL);
