...
INSERT INTO options (option_name, option_value, autoload) VALUES
  ('company_name', 'DaycarePRO', 1),
  ('slogan', 'daycare management system', 1),
  ('email', 'app@admin.com', 1),
  ('phone', '12345677', 1),
  ('fax', '1234566', 1),
  ('street', '1245 State st', 1),
  ('street2', '', 1),
  ('city', 'New York', 1),
  ('state', 'NY', 1),
  ('postal_code', '12345', 1),
  ...
  ('google_analytics', '', 1),
  ('currency_symbol', '$', 1),
  ('currency_abbreviation', 'USD', 1),
  ('date_format', 'm/d/Y h:i a', 1),
  ('allow_registration', '0', 1),
  ('allow_reset_password', '1', 1),
  ('enable_captcha', '0', 1),
  ('demo_mode', '0', 1),
  ...
  ('smtp_port', '25', 1),
  ('logo', 'logo.png', 1),
  ('invoice_logo', 'invoice_logo.png', 1),
  ('stripe_pk_live', '', 1),
  ('stripe_sk_live', '', 1),
  ('stripe_pk_test', '', 1),
  ('stripe_sk_test', '', 1),
  ...
  ('logo_bg_color', '', 1),
  ('top_nav_bg_color', '', 1),
  ('top_nav_link_color', '', 1),
  ('left_sidebar_bg_color', '', 1),
  ('left_sidebar_link_color', '', 1),
  ('custom_css', '', 1),
