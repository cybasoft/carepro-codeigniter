...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2015 at 02:53 AM
...
CREATE TABLE IF NOT EXISTS `accnt_invoices` (
...
INSERT INTO `accnt_invoices` (`id`, `child_id`, `invoice_date`, `invoice_due_date`, `invoice_terms`, `invoice_status`) VALUES
(1, 1, '12/04/2014', '12/11/2014', 'asdfas', 2),
(2, 1, '12/10/2014', '12/10/2014', 'asdf', 2),
(3, 1, '12/03/2014', '12/04/2014', 'Tersms', 2);
