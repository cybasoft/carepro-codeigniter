        ...
        <?php foreach ($users as $user) : ?>
            <div class="info-box" style="border-right:solid 1px #ccc;background:#f9f9f9;padding:5px;">
                <div class="info-box-img">
                    <img class="img-circle" style="height:80px;width:80px;" src="<?php echo is_file(APPPATH . '../assets/uploads/users/' . $user['photo']) ? base_url('assets/uploads/users/' . $user['photo']) : base_url('assets/img/content/no-image.png'); ?>">
                ...
                <div class="info-box-content">
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div class="info-box-more mt-3">
                                <a id="<?php echo $user['user_id']; ?>" onclick="editUser('<?php echo $user['user_id']; ?>')" class="cursor">
                                    <span class="btn btn-default btn-xs">
                                        <i class="fa fa-pencil-alt"></i></span>
                                </a>
                                <?php if (!is('staff')) : echo anchor('users/delete/' . $user['user_id'], '<span class="btn btn-danger btn-xs"><i class="fa fa-trash-alt"></i></span>', 'class="delete"');
                                endif; ?>
                            </div>
                        </div>
                        <div class="col-sm-4">
