<div class="modal show" id="check-in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"
     style="display:block">
                        ...
                        <div class="list-group-item">
                            <div class="media">
                                <div class="align-self-start mr-2">
                                    <img class="img-thumbnail" src="<?php echo $this->user->photo($p->photo); ?>"
                                ...
                                <div class="ml-auto">
                                    <input type="radio"
                                           ...
                                           name="<?php echo $action=="checkin"?'in_guardian':'out_guardian'; ?>"
