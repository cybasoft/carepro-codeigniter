    ...
    <div class="col-sm-10">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a class="btn btn-default btn-xs" href="<?php echo site_url('child/' . $child->id . '/health#allergies'); ?>">
                        ...
                        <a class="btn btn-default btn-xs" href="<?php echo site_url('child/' . $child->id . '/health#problem-list'); ?>">
                        ...
                        <a class="btn btn-default btn-xs" href="<?php echo site_url('child/' . $child->id . '/health#emergency_contacts'); ?>">
                            <?php echo lang('emergency_contacts'); ?>
                        </a>
                        <a class="btn btn-default btn-xs" href="<?php echo site_url('child/' . $child->id . '/health#providers'); ?>">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a class="btn btn-default btn-xs" href="<?php echo site_url('child/' . $child->id . '/notes#notes'); ?>">
                            <?php echo lang('notes'); ?>
                        </a>
                        <a class="btn btn-default btn-xs" href="<?php echo site_url('child/' . $child->id . '/notes#incidents'); ?>">
                ...
                <?php $rooms = $this->db->where('child_id', $child->id)->from('child_room')->join('child_rooms', '(child_room.room_id=child_rooms.id AND child_rooms.daycare_id=child_room.daycare_id)')->get();?>
                ...
                <div class="card">
                    <div class="card-header with-border">
                        <h4 class="card-title btn-block"><?php echo lang('parents'); ?>
                            <?php if (!is('parent')) : ?>
                                <button type="button" id="<?php echo $child->id; ?>" class="btn btn-default btn-xs  assign-parent-btn pull-right">
