...
<div class="box box-info box-solid">
    <div class="box-header">
        ...
        <div class="box-tools pull-right">
            <?php if (!is('parent')): ?>
            <a href="#" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#updateChildModal"><span class="fa fa-pencil-alt"></span>
            </a>
            <?php endif; ?>
        </div>
    </div>
...
<script>
    $('.checkin-btn').click(function() {
        ...
        $('.my_modal').load('<?php echo site_url('
            child '); ?>/' + child_id + '/checkIn').modal();
    });
    $('.checkout-btn').click(function() {
        var child_id = $(this).attr('id');
        $('.my_modal').load('<?php echo site_url('
            child '); ?>/' + child_id + '/checkOut').modal();
    });
