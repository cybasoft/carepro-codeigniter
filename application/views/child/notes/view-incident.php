...
<?php $incident = $this->db
    ...
    ->select("ci.*,u.first_name as first_name,u.last_name as last_name,u.name as name")
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <?php if (is(['admin', 'staff', 'manager'])) : ?>
                        <form action="<?php echo site_url('notes/storeIncidentPhotos'); ?>" enctype="multipart/form-data" class="dropzone" id="image-upload" method="POST">
