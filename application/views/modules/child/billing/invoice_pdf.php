    ...
    <tr>
        ...
        <td rowspan="5" style="text-align: right;">
            <img style="width:200px"
                 src="<?php echo APPPATH.'../assets/uploads/content/'.get_option('invoice_logo'); ?>"/>
            <br/>
            <strong><?php echo get_option('company_name'); ?></strong><br/>
            <?php
            $street = get_option('street');
            $street2 = get_option('street2');
            $city = get_option('city');
            $state = get_option('state');
            $zip = get_option('postal_code');
            ?>
            <?php
