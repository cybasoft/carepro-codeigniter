			...
			<div class="box-body">
				...
				<table class="table no-border">
					<tr>
						...
						<td><input type="text" name="phone" value="<?php echo $user_data->phone; ?>" class="form-control" required=""/></td>
					</tr>
					<tr>
						<td><?php echo lang('other_phone'); ?></td>
						<td><input type="text" name="phone2" value="<?php echo $user_data->phone2; ?>" class="form-control"/></td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" name="zip" value="<?php echo $user_data->zip; ?>" class="form-control" required=""/>
						</td>
					</tr>
					<tr>
						<td><?php echo lang('country'); ?></td>
						<td><input type="text" name="country" value="<?php echo $user_data->country; ?>" class="form-control"/>
						</td>
					</tr>
					<tr>
						<td></td>
			...
			<div class="box-body">
				...
				<table class="table no-border">
					...
					<tr>
						...
						<td><input type="password" name="new_password_confirm" value="" class="form-control" required=""/></td>
					</tr>
					<tr>
						<td></td>
						<td class="text-right">
