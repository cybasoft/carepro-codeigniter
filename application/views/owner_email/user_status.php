      ...
      <div style="background-color:white;padding: 4% 3%;">
         ...
         <p>
            ...
            <?php else : ?>
               ...
               Visit Link: <br />
               <p>
                  <a href="<?php echo base_url(); ?><?php echo $daycare_id; ?>/login" style="background-color: #EB6C6A;color: white;text-decoration: none;padding: 11px 35px;font-weight: 600;font-size: 17px;">Visit Dashboard</a>
               </p>
            <?php endif; ?>
         </p>
         Thanks!<br />
