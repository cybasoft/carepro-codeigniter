...
<body>
    <div style="width: 93%;background: #D5F2F4 !important;height: 100%;padding: 4% 3%;">
        <div style="background-color:white;padding: 4% 3%;">
            ...
            Activation link: <br />
            <p>
                <a href="<?php echo base_url(); ?><?php echo $daycare_id ?>/parents" style="background-color: #EB6C6A;color: white;text-decoration: none;padding: 11px 35px;font-weight: 600;font-size: 17px;">Visit Parent Dashboard</a><br /><br />
            </p>
            Thanks!<br />
            Daycarepro Team
            </a>
