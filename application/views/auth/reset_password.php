...
<div class="wrap-input100 validate-input" data-validate="<?php echo lang('This field is required'); ?>">
    ...
    <span class="label-input100"><?php echo sprintf(lang('reset_password_new_password_label'), $min_password_length); ?></span>
</div>
<div class="wrap-input100 validate-input" data-validate="<?php echo lang('This field is required'); ?>">
    <?php echo form_input([
        'name' => 'new_confirm',
    ...
    <span class="focus-input100"></span>
    <span class="label-input100"><?php echo lang('reset_password_new_password_confirm_label', 'new_password_confirm'); ?></span>
</div>
