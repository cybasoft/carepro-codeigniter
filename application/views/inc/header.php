...
<head>
	<meta charset="UTF-8">
	<title><?php echo $this->company->company()->name; ?></title>
	...
	<link href="<?php echo base_url(); ?>assets/css/vector.css" rel="stylesheet" type="text/css"/>
	<link href="<?php echo base_url(); ?>assets/css/summernote.min.css" rel="stylesheet" type="text/css"/>
