        ...
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">
                    ...
                    <i class="fa fa-question-circle show-tip" data-toggle="tooltip" title="<?php echo lang('Leave fields blank to deactivate'); ?>"></i>
                </h4>
            </div>
            <div class="card-body">
                <?php
                if (session('company_demo_mode') == 0) {
                    ...
                    <div class="custom-control custom-switch mb-3">
                        <input type="checkbox" class="custom-control-input" id="stripe_toggle" name="stripe_toggle"
                         ...
                         ?>
                        >
                        <label class="custom-control-label" for="stripe_toggle">Toggle to activate test stripe</label>
                    </div>
