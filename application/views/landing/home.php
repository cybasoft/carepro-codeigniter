        ...
        <div class="row">
            ...
            <div class="span5">config->item('name','company')
                ...
                <p>
                    ...
                    <?php echo $this->config->item('name','company'); ?> allows you to keep a register of children enrolled, billing, emergency contacts, individuals authorized to
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="span4 bouncy">
                ...
                <p><?php echo $this->config->item('name','company'); ?> is built on the awesome frontend framework Bootstrap for an easy and impressive access to all features</p>
