<div class="row no-print">
	<div class="col-lg-4">
		<div class="callout callout-info">
         ...
         src="' . base_url() . 'assets/companies/'.$this->company->company()->code.'/images/children/' . $child->photo . '" style="width:80px; height:80px"/>';
			} else {
				echo '<img class="img-circle"
         src="' . base_url() . 'assets/images/no-image.png" style="width: 80px; height:60px"/>';
			}
			?>
			<h4>
