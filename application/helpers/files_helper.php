    ...
    <div class="path main-nav">
        ...
        if($path != '') {
            ...
            for ($i = 0; $i < $count; $i++) {
                ...
                $array[] = "<li><a href='?p={$parent_enc}'>".fm_enc(fm_convert_win($exploded[$i]))."</a></li>";
            }
            $root_url .= $sep.implode($sep, $array);
        }
        ?>
        <div class="break-word float-left">
            <ul class="crumbs">
                <li><a href='?p='><i class='fa fa-home' style="font-size:1em" aria-hidden='true'
                                     title='<?php echo FM_ROOT_PATH; ?>'></i></a></li>
                <?php echo $root_url; ?>
            </ul>
        </div>
...
?>
<link rel="stylesheet" href="<?php echo assets('css/files.css'); ?>"/>
